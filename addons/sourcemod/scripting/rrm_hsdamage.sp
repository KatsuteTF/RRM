...
{
	cMin = CreateConVar("rrm_hsdamage_min", "0.1", "Minimum value for the random number generator.");
	cMax = CreateConVar("rrm_hsdamage_max", "2.0", "Maximum value for the random number generator.");
	...
	AutoExecConfig(true, "rrm_hsdamage", "rrm");
}
...
{
	RRM_Register("Headshots damage", gMin, gMax, false, RRM_Callback_HeadshotDamage);
}
